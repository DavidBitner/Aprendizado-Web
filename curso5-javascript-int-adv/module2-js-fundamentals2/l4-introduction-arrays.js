...
console.log(
  `${
    populations.length == 4
      ...
      : "The array does not have 4 elements"
  }`
);

const percentages = [
  percentage_of_world1(populations[0]),
  percentage_of_world1(populations[1]),
  percentage_of_world1(populations[2]),
  percentage_of_world1(populations[3]),
];
